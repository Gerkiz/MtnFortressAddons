...
---@param data_settings {name: string, tint: string|table,  max_health: number, resistances: table, pictures: data.SpriteSheet[]}
local function create_alternative_rock(data_settings)
    ...
    for index = 1, #rocks do
        ...
        if tint then
            if data_settings.pictures then
                rock.pictures = data_settings.pictures or data.raw['simple-entity']['iron-stromatolite'].pictures
            end
