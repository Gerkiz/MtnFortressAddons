	...
	{
		{
			...
			preparing_animation = worm_preparing_animation(Public.scales.giant_scale, Public.layers.giant_worm_layer_1,
				'forward'),
			...
			prepared_alternative_animation = worm_prepared_alternative_animation(Public.scales.giant_scale,
				Public.layers.giant_worm_layer_1),
			prepared_alternative_sound = sounds.worm_roar_alternative(0.7),
			starting_attack_speed = 0.03,
			starting_attack_animation = worm_start_attack_animation(Public.scales.giant_scale,
				Public.layers.giant_worm_layer_1),
			starting_attack_sound = sounds.worm_roars(1.0),
			ending_attack_speed = 0.03,
			ending_attack_animation = worm_end_attack_animation(Public.scales.giant_scale,
				Public.layers.giant_worm_layer_1),
			folding_speed = 0.015,
			folding_animation = worm_preparing_animation(Public.scales.giant_scale, Public.layers.giant_worm_layer_1,
				'backward'),
			...
			attack_parameters = {
				...
				range = 42,
				min_range = 0,
				projectile_creation_parameters = worm_shoot_shiftings(Public.scales.giant_scale,
					Public.scales.giant_scale * scale_worm_stream),
