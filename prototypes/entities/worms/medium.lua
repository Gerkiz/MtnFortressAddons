...
Public.common.set_worm_animations(data.raw.turret['medium-worm-turret'], scale_worm_medium, Public.layers.acid_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-medium-explosive-worm-turret'], scale_worm_medium, Public.layers.explosive_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-medium-fire-worm-turret'], scale_worm_medium, Public.layers.fire_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-medium-poison-worm-turret'], scale_worm_medium, Public.layers.poison_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-medium-piercing-worm-turret'], scale_worm_medium, Public.layers.piercing_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-medium-electric-worm-turret'], scale_worm_medium, Public.layers.electric_worm_layer_1)
...
data.raw.corpse['mtn-addon-medium-explosive-worm-corpse'].animation = worm_die_animation(scale_worm_medium, Public.layers.explosive_worm_layer_1)
data.raw.corpse['mtn-addon-medium-fire-worm-corpse'].animation = worm_die_animation(scale_worm_medium, Public.layers.fire_worm_layer_1)
data.raw.corpse['mtn-addon-medium-poison-worm-corpse'].animation = worm_die_animation(scale_worm_medium, Public.layers.poison_worm_layer_1)
data.raw.corpse['mtn-addon-medium-piercing-worm-corpse'].animation = worm_die_animation(scale_worm_medium, Public.layers.piercing_worm_layer_1)
data.raw.corpse['mtn-addon-medium-electric-worm-corpse'].animation = worm_die_animation(scale_worm_medium, Public.layers.electric_worm_layer_1)
