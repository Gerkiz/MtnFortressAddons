...
Public.common.set_worm_animations(data.raw.turret['big-worm-turret'], scale_worm_big, Public.layers.acid_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-big-explosive-worm-turret'], scale_worm_big, Public.layers.explosive_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-big-fire-worm-turret'], scale_worm_big, Public.layers.fire_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-big-poison-worm-turret'], scale_worm_big, Public.layers.poison_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-big-piercing-worm-turret'], scale_worm_big, Public.layers.piercing_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-big-electric-worm-turret'], scale_worm_big, Public.layers.electric_worm_layer_1)
...
data.raw.corpse['mtn-addon-big-explosive-worm-corpse'].animation = worm_die_animation(scale_worm_big, Public.layers.explosive_worm_layer_1)
data.raw.corpse['mtn-addon-big-fire-worm-corpse'].animation = worm_die_animation(scale_worm_big, Public.layers.fire_worm_layer_1)
data.raw.corpse['mtn-addon-big-poison-worm-corpse'].animation = worm_die_animation(scale_worm_big, Public.layers.poison_worm_layer_1)
data.raw.corpse['mtn-addon-big-piercing-worm-corpse'].animation = worm_die_animation(scale_worm_big, Public.layers.piercing_worm_layer_1)
data.raw.corpse['mtn-addon-big-electric-worm-corpse'].animation = worm_die_animation(scale_worm_big, Public.layers.electric_worm_layer_1)
