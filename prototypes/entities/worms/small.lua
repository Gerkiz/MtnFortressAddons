...
Public.common.set_worm_animations(data.raw.turret['small-worm-turret'], scale_worm_small, Public.layers.acid_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-small-explosive-worm-turret'], scale_worm_small, Public.layers.explosive_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-small-fire-worm-turret'], scale_worm_small, Public.layers.fire_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-small-poison-worm-turret'], scale_worm_small, Public.layers.poison_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-small-piercing-worm-turret'], scale_worm_small, Public.layers.piercing_worm_layer_1)
...
Public.common.set_worm_animations(data.raw.turret['mtn-addon-small-electric-worm-turret'], scale_worm_small, Public.layers.electric_worm_layer_1)
...
data.raw.corpse['mtn-addon-small-explosive-worm-corpse'].animation = worm_die_animation(scale_worm_small, Public.layers.explosive_worm_layer_1)
data.raw.corpse['mtn-addon-small-fire-worm-corpse'].animation = worm_die_animation(scale_worm_small, Public.layers.fire_worm_layer_1)
data.raw.corpse['mtn-addon-small-poison-worm-corpse'].animation = worm_die_animation(scale_worm_small, Public.layers.poison_worm_layer_1)
data.raw.corpse['mtn-addon-small-piercing-worm-corpse'].animation = worm_die_animation(scale_worm_small, Public.layers.piercing_worm_layer_1)
data.raw.corpse['mtn-addon-small-electric-worm-corpse'].animation = worm_die_animation(scale_worm_small, Public.layers.electric_worm_layer_1)
