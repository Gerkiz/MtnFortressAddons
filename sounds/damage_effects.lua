...
function Public.entity(offset_deviation, offset)
...
function Public.entity_higher(offset_deviation, offset)
...
function Public.wall(offset_deviation, offset)
    offset = offset or { 0, 1 }
    return {
        type = 'create-entity',
...
function Public.biter(offset_deviation, offset)
...
function Public.rock(offset_deviation, offset)
    offset = offset or { 0, 1 }
    return {
        type = 'create-entity',
...
function Public.flying_robot(offset_deviation, offset)
    offset = offset or { 0, 0 }
    return {
        type = 'create-entity',
